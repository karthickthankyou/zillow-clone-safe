...
const PopoverPanelFullWidth = ({
  ...
  <Transition
    ...
    className={`absolute px-2 -mx-2  gap-6 pt-2 pb-6 bg-white top-12 bg-opacity-90 backdrop-filter backdrop-blur ${className}`}
  >
    <Popover.Panel className='z-50 flex justify-center gap-6'>
      {children}
    </Popover.Panel>
  </Transition>
)
...
export { PopoverButton, PopoverOverlay, PopoverPanel, PopoverPanelFullWidth }
