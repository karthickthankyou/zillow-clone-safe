...
export function useMyPropertiesQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MyPropertiesQuery, MyPropertiesQueryVariables>(
    MyPropertiesDocument,
    options
  )
}
export function useMyPropertiesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyPropertiesQuery,
    MyPropertiesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<MyPropertiesQuery, MyPropertiesQueryVariables>(
    MyPropertiesDocument,
    options
  )
}
export type MyPropertiesQueryHookResult = ReturnType<
  typeof useMyPropertiesQuery
>
export type MyPropertiesLazyQueryHookResult = ReturnType<
  typeof useMyPropertiesLazyQuery
>
export type MyPropertiesQueryResult = Apollo.QueryResult<
  MyPropertiesQuery,
  MyPropertiesQueryVariables
>
